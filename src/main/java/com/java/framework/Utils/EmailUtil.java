...
public class EmailUtil {
	...
	public static void SendEmailNow(String hostName, String portID, String senderEmailID, String senderPassword,
		...
		StringBuffer body = new StringBuffer(
				"Hi All, <br> <br>  <b> NOTE: THIS IS AUTOMATED EMAIL</b><br> <br>Please find attached file <b>MAGIC_DK_PARTNER_PHASE1_AUTOMATION_REPORT.html</b> for the complete status of Phase 1 Automation. You need to Download the file to view it.<br> <br>");
		...
		try {
			send(host, port, mailFrom, password, receiverEmailArray, ccEmailArray, subject, body.toString(),
					inlineImages);
	...
	public static void send(String host, String port, final String userName, final String password,
			String[] toAddressArray, String[] ccEmailArray, String subject, String htmlBody,
